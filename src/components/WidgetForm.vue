<template>
  <div class="widget-form-container">
    ...
    <el-form :size="data.config.size" :class="data.config.customClass" label-suffix=":" :label-position="data.config.labelPosition" :label-width="data.config.labelWidth + 'px'">
